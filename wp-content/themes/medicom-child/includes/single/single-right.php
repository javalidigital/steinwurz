					...
					<div class="blog-style-2">
						...
						<article <?php post_class('blog-item') ?>>
							...
							<div class="blog-content">
									...
									<p class="blog-meta"><?php echo __('Comentários', 'medicom');?>: <a href="<?php comments_link(); ?>">
					<?php comments_number( __('0', 'medicom'), __('1', 'medicom'), __('%', 'medicom') ); ?></a> | <?php the_time(' j \d\e F \d\e Y') ?></p>
									<?php the_content(); ?>
									<?php $link = get_post_custom_values( 'link' ); ?>
									<?php if( !empty($link) ) : ?>
								<div class="link-repo">
									<ul>
										<li class="link-repo"><a href="<?php echo $link[0]; ?>" target="_blank"><i class="fa fa-external-link"></i>Clique aqui para ler a notícia completa</i></a></li>
									</ul>
